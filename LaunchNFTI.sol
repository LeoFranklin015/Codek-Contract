...
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.3/contracts/token/ERC1155/utils/ERC1155Holder.sol";
import "./ILaunchSettings.sol";
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.3/contracts/interfaces/IERC721.sol";
import "./IWETH.sol";
...
contract LaunchNftI is ERC721, ERC1155Holder, ERC721Holder, ERC2981{
    ...
    constructor(
        ...
        uint256 _priceOfNft,
        uint96 _curatorFee
    ) ERC721(_name, _symbol, _minter, _maxSupply) {
